                ...
                <div className="row no-gutters">
                    ...
                    <div className="col-md-8">
                        <div className="card-body">
                            ...
                            <p className="text-danger" style= {{fontSize:20}} >Precio antes:<s> {this.props.currency} {this.props.price} </s></p>
                            <p className="text-success" style= {{fontSize:20}}> Precio ahora:<strong> {this.props.currency} {this.props.discountPrice}</strong></p> 
                        </div>
                    </div>
                </div>
                </div>
